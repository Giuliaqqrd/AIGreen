...
export default {
  ...
  methods: {
    fetchSensorData() {
      // Genera dati fittizi per i grafici
    ...
    getMockData() {
      ...
      for (let d = startDate; d <= endDate; d.setDate(d.getDate() + 1)) {
        ...
        const co2 = Math.floor(Math.random() * (1000 - 300 + 1)) + 300; // CO2 range between 300 and 1000 ppm
        const voc = Math.floor(Math.random() * (1000 - 200 + 1)) + 200; // VOC range between 200 and 1000 ppb
        data.push({
